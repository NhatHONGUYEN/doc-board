      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <InfoNotice icon={<FileText size={14} />}>
            Keeping your professional information accurate and up-to-date
            ensures patients can make informed decisions.
            <span className="font-medium block mt-1 text-blue-200">
              Your credentials are displayed on your public profile and
          ...
          <InfoNotice icon={<Users size={14} />}>
            These statistics reflect your practice activity and patient
        ...
        <div className="md:col-span-1 ">
          <div className="space-y-3 sticky top-20">
            ...
            >
              This profile card shows how patients will see your information
